      ...
      <Container>
        <div className=' relative pt-[75px] pr-28 pl-[70px] pb-[71px] bg-[#F3F7FA] rounded-[20px] flex flex-wrap justify-between'>
          ...
          <div className='w-[360px]'>
            ...
            <button className='w-full duration-300 bg-[#FF7F5C] font-bold text-base leading-[30px] border border-[#FF7F5C] uppercase text-white rounded-md pt-4 pb-[14px] hover:bg-white hover:border-primary hover:text-primary hover:border'>Get Started</button>
          </div>
        </div>
      </Container>
    </section>
