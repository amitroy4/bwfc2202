...
const Choose = () => {
  ...
  return (
    <section className='font-manrope'>
      <Container>
        <div className='w-[1172px] bg-secondary pt-[56px] rounded-[20px] pl-[81px] pr-[81px] pb-[58px] relative'>
          ...
          <div className='flex justify-between flex flex-wrap mt-[79px] gap-y-[40px]'>
            {choose.items.map((citems) => (
              citems.visibility && <div className='w-[48%] bg-white pt-[59px] pb-[37px] pl-[120px] pr-[47px] rounded-[20px] relative'>
                ...
                <p className='font-regular text-[18px] pt-[22px]'>{citems.details}</p>
                <div className={`h-[58px] w-[58px] rounded-full bg-[${citems.circleColor}] absolute top-[59px] left-[30px]`}></div>
              </div>
