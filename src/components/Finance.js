      ...
      <Container>
        <div className='flex flex-row'>
          <div className="basis-1/2">
            <h4 className='text-primary font-manrope uppercase text-lg font-extrabold mb-6'>{finance.sunbTitle}</h4>
            <h1 className='font-manrope text-[50px] font-bold w-[550px] leading-[56px] mb-7'>{finance.heading}</h1>
            <p className='font-manrope text-[18px] font-regular w-[500px] leading-[26px] text-[#757095]'>{finance.paragraph}</p>
