...
const Banner = () => {
  ...
  return (
    <section>
      <div style={{ backgroundImage: `url(${BannerData.bannerbgshape}` }} className='w-full'>
        <Container>
          <div className='flex justify-between'>
            <div className='w-[50%]'>
              <h1 className='font-manrope w-[646px] font-extrabold text-[60px]'>{BannerData.bannerheading}</h1>
