      ...
      <Container>
        <div className='flex justify-between font-manrope'>
          <div>
            ...
            <p className='w-[515px] mb-7 text-[18px] leading-[26px] text-[#757095] font-normal'>{accountinfo.paragraph}</p>
            <a href={accountinfo.button.link} className='inline-block text-center w-[162px] rounded-lg bg-primary text-white py-[14px] font-bold text-base leading-[30px] border border-primary hover:bg-white hover:text-primary duration-300 drop-shadow-accbtn'>{accountinfo.button.text}</a>
          </div>
